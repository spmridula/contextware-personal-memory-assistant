 ...
 */
export function findBestMatch(queryEmbedding, storedFaces, threshold = 0.65) {
 ...
 * Higher = fewer false positives (unknown faces shown as Unknown)
 */
...
export const THRESHOLD_INFO = {
  low: { value: 0.55, label: 'Low (more false positives)' },
  medium: { value: 0.65, label: 'Medium (balanced)' },
  high: { value: 0.72, label: 'High (more strict)' },
  veryHigh: { value: 0.8, label: 'Very High (very strict)' },
};
